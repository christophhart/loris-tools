namespace ZoomHandler
{
	...
	ZoomPanel.set("x", INTERFACE_WIDTH - 24);
	ZoomPanel.set("y", INTERFACE_HEIGHT - 24);
	ZoomPanel.set("width", 24);
	ZoomPanel.set("height", 24);
	ZoomPanel.set("allowCallbacks", "All Callbacks");
